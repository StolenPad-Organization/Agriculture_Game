...
public class CleaningAndLoosing : MonoBehaviour
{
    ...
    private void OnCollisionEnter(Collision collision)
    {
        ...
        if (chunkCount < maxChunks && collision.gameObject.CompareTag(GRASS) && state == State.cleaning)
        {
        ...
        if (state == State.loosing && collision.gameObject.CompareTag(DIRT) && !Player.Instance.PlayerHasCollectables())
        {
